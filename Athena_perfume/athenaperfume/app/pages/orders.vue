<template>
  <div class="flex flex-col gap-6 p-6" dir="rtl">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-2xl font-bold" style="color: #1a0a0c">
          مدیریت سفارشات
        </h1>
        <p class="text-sm" style="color: #1a0a0c">
          پیگیری و مدیریت سفارشات عطر
        </p>
      </div>
      ...
      <UCard style="background-color: #d8cfc4">
        <div class="text-center">
          <p class="text-sm" style="color: #1a0a0c">سفارشات این هفته</p>
          <p class="text-3xl font-bold" style="color: #3b0510">
            {{ weeklyOrdersCount }}
          </p>
        </div>
      </UCard>
    ...
    <UCard style="background-color: #d8cfc4">
      <div class="flex flex-wrap gap-4 items-end">
        ...
        <div class="flex-1 min-w-[250px]">
          <label class="text-sm font-medium mb-2 block" style="color: #1a0a0c"
            >جستجو بر اساس شناسه تراکنش</label
          >
          <UInput
            v-model="searchTerm"
        ...
        <template #expanded="{ row }">
          <div
            ...
            style="
              ...
              border-color: rgba(26, 10, 12, 0.2);
            "
          >
            <h4 class="font-semibold mb-3" style="color: #1a0a0c">
              اقلام سفارش:
            </h4>
            <div class="space-y-2">
              <div
                ...
                style="background-color: #e6ded3"
              >
                <div class="flex items-center gap-3">
                  <UIcon name="i-lucide-package" style="color: #3b0510" />
                  <div>
...
const columns = [
  ...
  },
  {
    ...
    header: () => h("div", { style: "color: #1A0A0C;" }, "شناسه تراکنش"),
    cell: ({ row }) =>
      h(
        "div",
        {
  ...
  },
  {
    ...
    header: () => h("div", { style: "color: #1A0A0C;" }, "نام مشتری"),
    cell: ({ row }) =>
      h("div", { style: "color: #1A0A0C;" }, row.getValue("customerName")),
  },
  {
    accessorKey: "date",
    header: () => h("div", { style: "color: #1A0A0C;" }, "تاریخ سفارش"),
    cell: ({ row }) =>
      h("div", { style: "color: #1A0A0C;" }, formatDate(row.getValue("date"))),
  },
  {
    accessorKey: "deliveryStatus",
    header: () => h("div", { style: "color: #1A0A0C;" }, "وضعیت ارسال"),
    cell: ({ row }) => {
  ...
  {
    accessorKey: "items",
    header: () => h("div", { style: "color: #1A0A0C;" }, "اقلام"),
    cell: ({ row }) => {
  ...
  {
    id: "actions",
    header: () => h("div", { style: "color: #1A0A0C;" }, "عملیات"),
    cell: ({ row }) =>
      h(
        UButton,
        {
...
const filteredOrders = computed(() => {
  ...
  if (selectedStatus.value && selectedStatus.value.value !== null) {
    result = result.filter(
      (order) => order.deliveryStatus === selectedStatus.value.value
    );
  }
